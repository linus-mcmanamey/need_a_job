...
class TestLinkedInPollerRunOnce:
    ...
    def test_run_once_continues_after_individual_job_error(
        ...
        jobs = [
            {'title': 'Job 1', 'company': 'Co 1', 'job_url': 'https://test.com/1', 'posted_date': '2025-01-15'},
            {'title': 'Job 2', 'company': 'Co 2', 'job_url': 'https://test.com/2', 'posted_date': '2025-01-15'},
        ]
