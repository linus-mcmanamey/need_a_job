...
const menuSections = [
  {
    ...
    items: [
      ...
      },
      {
        id: 'history',
        name: 'History',
        icon: 'M10,0.4c-5.303,0-9.601,4.298-9.601,9.6c0,5.303,4.298,9.601,9.601,9.601c5.301,0,9.6-4.298,9.6-9.601C19.6,4.698,15.301,0.4,10,0.4z M9.999,17.6c-4.197,0-7.6-3.402-7.6-7.6c0-4.197,3.402-7.6,7.6-7.6c4.197,0,7.601,3.402,7.601,7.6C17.6,14.197,14.196,17.6,9.999,17.6z M10.635,4.553c0-0.35-0.282-0.632-0.633-0.632c-0.35,0-0.633,0.282-0.633,0.632v5.447l4.419,2.614c0.301,0.177,0.689,0.081,0.866-0.219c0.177-0.301,0.081-0.689-0.22-0.867L10.635,9.263V4.553z'
      },
      {
        id: 'pipeline',
        name: 'Pipeline',
